...
@section('content')
    <header>
        <div class="main">Get info from youtube</div>
        <ul>
            <a href="https://todo-tasks-laravel.gq/ar" target="_blank">
                <li>To do list</li>
            </a> 
            <a href="https://t.me/yu5uy" target="_blank">
                <li>Contact us</li>
            </a>
            <a href="https://www.paypal.com/paypalme/LNG1" target="_blank">
                <li>Buy me coffee</li>
            </a>
        </ul>
    </header>
    <section>
        <div class="container-title-svg">
            <div class="svg-vid-container d-none">
                <svg class="svg-vid" viewBox="0 0 477.867 477.867">
                    <path
            ...
            <div class="title">Enter Video Youtube and i will retrieving all info about it</div>
        </div>
        <div style="width: 40%;min-width:300px;margin:0 auto;">
            <svg style="width:100%;" viewBox="0 0 982.48732 763.01413">
                ...
                <path
                    ...
                    transform="translate(-108.75634 -68.49293)" fill="#da0037" />
                <path
                ...
                <circle cx="348.90479" cy="142.89813" r="9.99975" fill="#da0037" />
                ...
                <circle cx="294.90486" cy="358.8982" r="29" fill="#da0037" />
        ...
        <div class="container-info-url">
            <div class="child">
                <input type="button" value="GET" class="get-vid">
                <div style="height:20px;"></div>
            </div>
            <div class="child">
                <input type="text" id="url-youtube" placeholder="type here url">
                <small class="note-url">Enter valid youtube url</small>
            </div>
        </div>

        <div class="result text-center">
            {{-- <div class="card"><div class="card-header ">الوصف</div><div class="card-body text-right dir-rtl">
                <span>احمد الخطيب</span>
                <span>شطرنج</span>
                <span>تعليم الشطرنج</span>
            </div><div class="copy-btn ">نسخ كامل</div></div> --}}
        </div>
    </section>
    <footer class="text-center">
        <a href="https://t.me/yu5uy"> Code by @YU5UY <span style="color:var(--third-color);">&hearts;</span></a>
    </footer>
    <input type="hidden" value="{{ csrf_token() }}" id="csrf" />
    <input type="hidden" value="{{ route('getData') }}" id="route-data" />
@endsection
